...
- **主要技術**：
  ...
  - JavaScript
  - IndexedDB 用於儲存字型資料
  - [potrace.js](https://github.com/kilobtye/potrace) 用於將繪製的圖像轉換為 SVG。
  - [opentype.js](https://github.com/opentypejs/opentype.js) 用於生成 OTF 字型檔案。
...
- **字型權利**：
  - 使用者生成的字型檔案的所有權屬於使用者，可自由公開或商業使用。
...
- **主な技術**：
  ...
  - [potrace.js](https://github.com/kilobtye/potrace) を使用して描画した画像を SVG に変換。
  - [opentype.js](https://github.com/opentypejs/opentype.js) を使用して OTF フォントファイルを生成。
